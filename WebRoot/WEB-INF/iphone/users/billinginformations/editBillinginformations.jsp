...
<html>
<head>
<title>Edit <fmt:message key="users.title"/> <fmt:message key="billinginformation.title" /></title>
</head>
<body>
...
<form:form name="editform" action="${pageContext.request.contextPath}/saveUsersBillinginformations" method="POST" modelAttribute="billinginformation">
