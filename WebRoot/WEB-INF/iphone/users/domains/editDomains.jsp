...
<html>
<head>
<title>Edit <fmt:message key="users.title"/> <fmt:message key="domain.title" /></title>
</head>
<body>
...
<form:form name="editform" action="${pageContext.request.contextPath}/saveUsersDomains" method="POST" modelAttribute="domain">
