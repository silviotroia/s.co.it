...
<html>
<head>
<title>View <fmt:message key="domain.title"/> <fmt:message key="users.title" /></title>
</head>
<body>
<div id="topbar">
	<div id="title"><fmt:message key="users.title"/></div>
	<div id="leftnav"><a href="${pageContext.request.contextPath}/selectDomain?idKey=${domain_id}&"><fmt:message key="navigation.back"/></a></div>
	<div id="rightbutton"><a href="${pageContext.request.contextPath}/editDomainUsers?domain_id=${domain_id}&users_id=${users.id}&"><fmt:message key="navigation.edit"/></a></div>
</div>
<div id="content">
	...
	<a href="${pageContext.request.contextPath}/deleteDomainUsers?domain_id=${domain_id}&related_users_id=${users.id}&" class="bigButton red"><fmt:message key="navigation.delete"/></a>
</div>
</body>
</html>
