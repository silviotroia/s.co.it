...
<html>
<head>
<title>Edit <fmt:message key="domain.title"/> <fmt:message key="users.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveDomainUsers" method="POST" modelAttribute="users">
