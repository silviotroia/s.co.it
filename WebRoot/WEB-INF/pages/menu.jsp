...
<div id="contentarea">				
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			<h1>Spring MVC</h1>
			<p class="line">&nbsp;</p>
			<jsp:include page="/WEB-INF/pages/billinginformation/menu.jsp" />
<jsp:include page="/WEB-INF/pages/users/menu.jsp" />
<jsp:include page="/WEB-INF/pages/authorities/menu.jsp" />
<jsp:include page="/WEB-INF/pages/domain/menu.jsp" />
<jsp:include page="/WEB-INF/pages/shorten/menu.jsp" />
<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
